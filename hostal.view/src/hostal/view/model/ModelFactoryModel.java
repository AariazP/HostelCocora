package hostal.view.model;
import hostal.view.*;
import hostal.view.views.*;
import hostal.*;
...
// Clase estatica oculta. Tan solo se instanciara el singleton una vez
   ...
   public static ModelFactoryModel getInstance()  { 
     ...
     ModelFactory modelFactory = hostalFactory.eINSTANCE.createModelFactory();

   static String URL = "/test/src/model/model.hostal";
