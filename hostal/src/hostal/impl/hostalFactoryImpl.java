 ...
 * @generated
 */
public class hostalFactoryImpl extends EFactoryImpl implements hostalFactory {
	/**
	 ...
	 * @generated
	 */
	public static hostalFactory init() {
		try {
			hostalFactory thehostalFactory = (hostalFactory)EPackage.Registry.INSTANCE.getEFactory(hostalPackage.eNS_URI);
			if (thehostalFactory != null) {
				return thehostalFactory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new hostalFactoryImpl();
	}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case hostalPackage.MODEL_FACTORY: return createModelFactory();
			default:
	 ...
	 * @generated
	 */
	public hostalPackage gethostalPackage() {
		return (hostalPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static hostalPackage getPackage() {
		return hostalPackage.eINSTANCE;
	}
