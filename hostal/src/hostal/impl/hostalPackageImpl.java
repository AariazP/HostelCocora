...
import hostal.domain.impl.DomainPackageImpl;
 ...
 * @generated
 */
public class hostalPackageImpl extends EPackageImpl implements hostalPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see hostal.hostalPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private hostalPackageImpl() {
		super(eNS_URI, hostalFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link hostalPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static hostalPackage init() {
		if (isInited) return (hostalPackage)EPackage.Registry.INSTANCE.getEPackage(hostalPackage.eNS_URI);

		// Obtain or create and register package
		hostalPackageImpl thehostalPackage = (hostalPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof hostalPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new hostalPackageImpl());
		...
		thehostalPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(hostalPackage.eNS_URI, thehostalPackage);
		return thehostalPackage;
	}
	 ...
	 * @generated
	 */
	public hostalFactory gethostalFactory() {
		return (hostalFactory)getEFactoryInstance();
	}
